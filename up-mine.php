...
$Miner = mysqli_fetch_assoc($result);

$currentLevel = $Miner['buildings_level'];
    ...
    if ($newLevel > 0 && $newLevel <= 16) {
        ...
        if ($result) {
            ...
            if (
                ...
                $query = "UPDATE `buildings_user` SET buildings_level = $newLevel+1 WHERE id_user = '$myID' AND id_buildings = 1";
...
if ($currentLevel < 16) {
    echo '<a class="simple-but border mb5" href="up-mine?level=' . ($currentLevel) . '">';
