...
if (isset($_GET['buy-standart'])) {
    if ($nation['Country'] != 'ussr') {
        if ($users['gold'] >= 400) {
            if ($users['tankLevel'] > 1) {
                $query = "UPDATE `users` 
                          SET `gold` = `gold` - 400, 
                              `img` = 'img/countr/tanks/ssr-tt.png', 
                              `attach` = `attach` - ?, 
                              `armor` = `armor` - ?, 
                              `accuracy` = `accuracy` - ?, 
...
if(isset($_GET['buy-st'])){
    if($nation['Country'] == 'ussr'){
        if($users['gold'] >= 700){
            ...
            `health` = `health` + 200 , `gold` = `gold` - 700, `img` = 'img/countr/tanks/st-buy-ussr.png', `tankLevel` = 2 WHERE id = ?";
            $stmt = $connect->prepare($query);
...
if(isset($_GET['tt-buy'])){
    if($nation['Country'] == 'ussr'){
        if($users['gold'] >= 2000){
            if($users['img'] == 'img/countr/tanks/st-buy-ussr.png'){
                $query = "UPDATE `users` SET `attach` = `attach` + 500 , `armor` = `armor` + 500 , `accuracy` = `accuracy` + 500 ,
                `health` = `health` + 500 , `gold` = `gold` - 2000, `img` = 'img/countr/tanks/tt-buy-ussr.png',`tankLevel` = 3 WHERE id = ?";
                $stmt = $connect->prepare($query);
...
<div class="white"><img src="img/ico/victory.png"> Страна: <span class="green2" w:id="country">СССР</span> <img src="img/ico/victory.png"></div>
</div>';
...
<td style="width:33%;">
<a class="white" w:id="selectUssr" href="newstore-ussr">
СССР<br>
<img src="img/countr/ussr.png" width="70" height="47" w:id="flagImg" style="">
</a>
</td>
<td style="width:33%;">
...
<div class="wrap1"><div class="wrap2"><div class="wrap3"><div class="wrap4"><div class="wrap5"><div class="wrap6"><div class="wrap7"><div class="wrap8">
<div class="wrap-content cntr custombg bg_ussr flag_short" w:id="bgDiv">
<div class="small sh_b bold">

<div class="white mb5 mt5">Выбранный танк</div>

<div>
<div class="small bold va_m"><img width="16" height="11" src="img/country/ussr16x11.png"> <span class="white">'.($nation['Country'] == 'ussr' ? $nation['Type'] : 'Тяжелый танк') .'</span></div>
</div>
...
if($nation['Country'] != 'ussr'){
echo '<td class="cntr"><img class="tank-img tankimgposfix" alt="tank" src="img/countr/tanks/ssr-tt.png"></td>';
}else{
...
<img width="14" height="14" src="img/ico/attack.png?1" alt="Атака" title="Атака"> <span class="green2">' . $users['attach']. (($users['tankLevel'] != 2 or $users['tankLevel'] != 3) && $nation['Country'] != 'ussr' && $users['tankLevel'] != 1 ? '<span class="red1"> -' . $AddStatsForTank . '</span>' : '') . '<br>
<img width="14" height="14" src="img/ico/armor.png?1" alt="Броня" title="Броня"> <span class="green2">'.$users['armor']. (($users['tankLevel'] != 2 or $users['tankLevel'] != 3) && $nation['Country'] != 'ussr' && $users['tankLevel'] != 1 ? '<span class="red1"> -' . $AddStatsForTank . '</span>' : '') . '<br>

<img width="14" height="14" src="img/ico/accuracy.png?1" alt="Точность" title="Точность"> <span class="green2">'.$users['accuracy']. (($users['tankLevel'] != 2 or $users['tankLevel'] != 3) && $nation['Country'] != 'ussr' && $users['tankLevel'] != 1 ? '<span class="red1"> -' . $AddStatsForTank . '</span>' : '') . '<br>

<img width="14" height="14" src="img/ico/durability.png?1" alt="Прочность" title="Прочность"> <span class="green2">'.$users['health']. (($users['tankLevel'] != 2 or $users['tankLevel'] != 3) && $nation['Country'] != 'ussr' && $users['tankLevel'] != 1 ? '<span class="red1"> -' . $AddStatsForTank . '</span>' : '') . '<br>
...
<div class="mb2 pb0">
<img src="img/ico/power.png?2" height="14" width="14"> <span class="green2">Танковая мощь: '.$MySumStats. (($users['tankLevel'] != 2 or $users['tankLevel'] != 3) && $nation['Country'] != 'ussr' && $users['tankLevel'] != 1 ? '<span class="red1"> -' . $AddStatsForTank * 4 . '</span>' : '') . '<br>
</div>
</div>
</div>';
if($nation['Country'] == 'ussr'){
...
<div class="wrap1"><div class="wrap2"><div class="wrap3"><div class="wrap4"><div class="wrap5"><div class="wrap6"><div class="wrap7"><div class="wrap8">
<div class="wrap-content cntr custombg bg_ussr" w:id="bgDiv">
<div class="small sh_b bold">

<div>
<div class="small bold va_m"><img width="16" height="11" src="img/country/ussr16x11.png"> <span class="white">Средний танк</span></div>
</div>

<table>
<tbody><tr>
<td class="cntr"><img class="tank-img tankimgposfix" alt="tank" src="img/countr/tanks/st-buy-ussr.png"></td>
...
<div class="mb2 pb0">
<img src="img/ico/power.png?2" height="14" width="14"> <span class="green2">Танковая мощь: '.$MySumStats. ($users['tankLevel'] == 3 && $users['Country'] != 'ussr' ? '<span class="red1"> -' . 500 * 4 . '</span>' : ($users['tankLevel'] != 2? '<span class="green1"> +1200</span></span>' : '')) . '</span>
</div>
</div>';

if($users['img'] == 'img/countr/tanks/st-buy-ussr.png' or $users['img'] == 'img/countr/tanks/tt-buy-ussr.png')
echo '<div class="bot"><span class="simple-but gray border"><span><span>Танк в наличии</span></span></span></div>';
else{
echo '<div class="bot">
...
<div>
<div class="small bold va_m"><img width="16" height="11" src="img/country/ussr16x11.png"> <span class="white">Тяжелый танк</span></div>
</div>

<table>
<tbody><tr>
<td class="cntr"><img class="tank-img tankimgposfix" alt="tank" src="img/countr/tanks/tt-buy-ussr.png"></td>
...
if($users['img'] == 'img/countr/tanks/tt-buy-ussr.png')
echo '<div class="bot"><span class="simple-but gray border"><span><span>Танк в наличии</span></span></span></div>';
else{
echo '<div class="bot">
